...
const DEFAULT_CREDLY_SAA_URL =
  "https://www.credly.com/badges/dcc73283-ffe7-47ec-b204-1c87c23a8711";
const DEFAULT_CREDLY_SECURITY_URL =
  "https://www.credly.com/badges/b41df2d4-e4f9-4587-9323-e5cfde1f1aa6";
...
const CERTIFICATIONS = [
  {
    ...
    credlyUrl: import.meta.env.VITE_CREDLY_SAA_URL || DEFAULT_CREDLY_SAA_URL,
  },
  {
    id: "security",
    ...
    credlyUrl:
      import.meta.env.VITE_CREDLY_SECURITY_URL || DEFAULT_CREDLY_SECURITY_URL,
  },
];
            ...
            <motion.a
              ...
              <div className="flex items-center justify-center gap-3 mb-2 min-h-[4rem] text-center">
                <span className="inline-flex items-center justify-center flex-shrink-0 group-hover:animate-twinkle">
                  <FaAward
                    className="text-primary-600 dark:text-primary-400 text-lg drop-shadow-sm"
                    aria-hidden
                  />
                </span>
